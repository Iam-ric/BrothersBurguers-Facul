...
<html lang="pt-br">
    ...
    <body style="min-height: 100vh; overflow: hidden" >
        ...
        <div class="container" style="position: relative; min-height: 100vh;">
            <form style="position: absolute; top: 50%; left: 50%; transform: translateY(-50%) translateX(-50%);" name="dados" method="post" action="../cadastro/cadastroEstoque.php?id=<?php echo $id; ?>">
                <legend>Aviso</legend>
                <label for="aviso" class="form-label">Tem certeza que deseja remover o produto <?php echo $nome ?>?</label>
